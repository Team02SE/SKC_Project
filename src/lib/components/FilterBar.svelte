<script lang="ts">
	...
	const dispatch = createEventDispatcher<{ filter: StatusValue[] }>();
...
>
	<button
		type="button"
		class="flex h-full items-center gap-2 rounded-4xl bg-light-primary px-4 inset-shadow-sm/25 border border-transparent hover:border-light-text-primary/20 transition-colors"
